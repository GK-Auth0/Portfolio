            ...
            <div className="group flex flex-col gap-6">
              <div className="relative overflow-hidden rounded-3xl bg-slate-100 dark:bg-slate-800 aspect-[16/10]">
                ...
                <div className="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4">
                  <a href="https://task-tracker-nine-rosy-92.vercel.app/" target="_blank" rel="noopener noreferrer" className="bg-white text-slate-900 px-6 py-3 rounded-xl font-bold flex items-center gap-2">
